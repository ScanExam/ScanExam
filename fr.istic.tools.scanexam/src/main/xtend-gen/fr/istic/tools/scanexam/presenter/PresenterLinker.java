...
public class PresenterLinker {
  public void linkEditorPresenter(final Adapter adapter, final ExamEditionService service) {
    final PresenterVueCreation presenter = new PresenterVueCreation(adapter, service);
    adapter.setPresenter(presenter);
  }
  
  public void linkGraduationPresenter(final Adapter adapter, final ExamGraduationService service) {
