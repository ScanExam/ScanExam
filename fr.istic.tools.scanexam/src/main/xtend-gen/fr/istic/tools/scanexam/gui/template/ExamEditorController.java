...
public class ExamEditorController extends MouseInputAdapter {
  public enum STATE {
    IDLE,
  ...
  QuestionZoneSelectionPanel cropping;
  ...
  private ExamEditorController.STATE state;
  
  public ExamEditorController(final QuestionZoneSelectionPanel c) {
    this.cropping = c;
