...
public class FXMockBackend extends ControllerVueCorrection {
  ...
  public void nextQuestion() {
    ...
    this.getController().showQuestion(this.currentQuestion);
  }
  ...
  public void setQuestions() {
    ...
    this.getController().initQuestionNames(stringList);
    this.index = 0;
    this.getController().showQuestion(this.questions.get(0));
  }
}
