...
import fr.istic.tools.scanexam.exportation.GradesExport;
import java.io.File;
    ...
    for (final Integer i : _doubleDotLessThan) {
      {
        ...
        cellName.setCellValue((((StudentSheet[])Conversions.unwrapArray(studentSheets, StudentSheet.class))[(i).intValue()]).getStudentID());
