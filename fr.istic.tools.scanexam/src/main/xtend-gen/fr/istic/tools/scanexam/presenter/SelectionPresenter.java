...
public abstract class SelectionPresenter {
  /**
   ...
   */
  public SelectionPresenter(final int windowWidth, final int windowHeight, final int scale, final int originX, final int originY, final BoxList selectionBoxes) {
