      ...
      for (final StudentSheet sheet : sheets) {
        {
          ...
          for (final Grade g : _grades) {
            ...
            for (final Comment c : _comments) {
              if ((c instanceof TextComment)) {
                ...
                int _pageId = ((TextComment)c).getPageId();
                int _id = sheet.getId();
                int _size = sheet.getPosPage().size();
                int _multiply = (_id * _size);
                int _plus = (_pageId + _multiply);
                PDPage page = document.getPage(_plus);
                ...
                float _multiply_1 = (_x * resolutiondiff);
                rectangleBottomLeftCornerX = _multiply_1;
                int _length_1 = text.length();
                boolean _lessEqualsThan = (_length_1 <= partitionSize);
                if (_lessEqualsThan) {
                  int _length_2 = text.length();
                  float _multiply_2 = (_length_2 * charWidth);
                  rectangleWidth = _multiply_2;
                  rectangleHeight = charHeight;
                  float _y = ((TextComment)c).getY();
                  float _multiply_3 = (_y * resolutiondiff);
                  float _minus = (pageHeight - _multiply_3);
                  rectangleBottomLeftCornerY = _minus;
                } else {
                  float _y_1 = ((TextComment)c).getY();
                  float _multiply_4 = (_y_1 * resolutiondiff);
                  float _minus_1 = (pageHeight - _multiply_4);
                ...
                float _multiply_5 = (_pointerX * resolutiondiff);
                float _pointerY = ((TextComment)c).getPointerY();
                float _multiply_6 = (_pointerY * resolutiondiff);
                float _minus_3 = (pageHeight - _multiply_6);
                contentStream.moveTo(_multiply_5, _minus_3);
                float _x_1 = ((TextComment)c).getX();
                float _multiply_7 = (_x_1 * resolutiondiff);
                float _plus_1 = (_multiply_7 + (rectangleWidth / 2));
                float _y_2 = ((TextComment)c).getY();
                float _multiply_8 = (_y_2 * resolutiondiff);
                float _minus_4 = (pageHeight - _multiply_8);
                contentStream.lineTo(_plus_1, _minus_4);
                ...
                float _multiply_9 = (_x_2 * resolutiondiff);
                float _y_3 = ((TextComment)c).getY();
                float _multiply_10 = (_y_3 * resolutiondiff);
                float _minus_5 = (pageHeight - _multiply_10);
                contentStream.newLineAtOffset(_multiply_9, _minus_5);
                {
                  int i = 0;
          ...
          String _plus_2 = ("Note : " + Float.valueOf(_computeGrade));
          String _plus_3 = (_plus_2 + "/");
          String _plus_4 = (_plus_3 + Float.valueOf(globalScale));
          contentStream_1.showText(_plus_4);
