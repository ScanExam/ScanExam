...
class GradesExportMailImpl implements GradesExportMail {
	...
	override exportGradesMail(File pdf) {
		exportGradesMail1(pdf,instance.email,instance.emailPassword,service.studentSheets.size,service.examName,service.studentSheets);				
	}
	
	override exportGradesMail1(File pdf,String mail,String mdp, int taille,String nameExam, Collection<StudentSheet> studentSheetss){
