...
class ExamGraduationService extends Service
{
	...
	/**
	 * Passe au etudiant prÃ©cÃ©dent dans les StudentSheet
	 */
	def previousStudent() 
	{
	...
	/**
	 * Renomme l'Ã©tudiant
	 * @param name le nouveau nom de l'Ã©tudiant
	 */
	...
	/**
	 * Ajoute une entrÃ©e Ã  la note d'une question d'une copie
	 * @param questionId l'ID de la question Ã  laquelle ajouter l'entrÃ©e
	 * @param l'ID de l'entrÃ©e dans l'Examen
	 */
	...
	/**
	 * Retire une entrÃ©e Ã  la note d'une question d'une copie
	 * @param questionId l'ID de la question Ã  laquelle retirer l'entrÃ©e
	 * @param l'ID de l'entrÃ©e dans l'Examen
	 */
    ...
    /**
     * @param l'ID de la question Ã  laquelle rÃ©cupÃ©rer la liste d'entrÃ©es
