...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CorePackage.EXAM_MARKER: return createExamMarker();
			case CorePackage.EXAM_MANAGER: return createExamManager();
	 ...
	 */
	@Override
	public ExamMarker createExamMarker() {
		ExamMarkerImpl examMarker = new ExamMarkerImpl();
		return examMarker;
	}
	 ...
	 */
	@Override
	public ExamManager createExamManager() {
