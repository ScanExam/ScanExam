...
public class GradeScaleImpl extends MinimalEObjectImpl.Container implements GradeScale {
	 ...
	 */
	@Override
	public boolean modifyStep(int id, float value) {
	 ...
	 */
	@Override
	public boolean addStep(String comment, float value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CorePackage.GRADE_SCALE___MODIFY_STEP__INT_FLOAT:
				return modifyStep((Integer)arguments.get(0), (Float)arguments.get(1));
			case CorePackage.GRADE_SCALE___REMOVE_STEP__INT:
				return removeStep((Integer)arguments.get(0));
			case CorePackage.GRADE_SCALE___GET_STEP__INT:
				return getStep((Integer)arguments.get(0));
			case CorePackage.GRADE_SCALE___ADD_STEP__STRING_FLOAT:
				return addStep((String)arguments.get(0), (Float)arguments.get(1));
		}
