...
public class CoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected CoreSwitch<Adapter> modelSwitch =
		new CoreSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExamMarker(ExamMarker object) {
				return createExamMarkerAdapter();
			}
			@Override
			public Adapter caseExamManager(ExamManager object) {
				return createExamManagerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.istic.tools.scanexam.core.ExamMarker <em>Exam Marker</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExamMarkerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fr.istic.tools.scanexam.core.ExamManager <em>Exam Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExamManagerAdapter() {
		return null;
	}
