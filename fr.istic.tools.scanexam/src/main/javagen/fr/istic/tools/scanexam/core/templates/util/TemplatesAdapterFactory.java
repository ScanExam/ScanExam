...
public class TemplatesAdapterFactory extends AdapterFactoryImpl {
	...
	protected TemplatesSwitch<Adapter> modelSwitch =
		new TemplatesSwitch<Adapter>() {
			@Override
			public Adapter caseCorrectionTemplate(CorrectionTemplate object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.istic.tools.scanexam.core.templates.CorrectionTemplate <em>Correction Template</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCorrectionTemplateAdapter() {
		return null;
	}
