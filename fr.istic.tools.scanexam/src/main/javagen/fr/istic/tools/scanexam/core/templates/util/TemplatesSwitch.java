/**
 */
package fr.istic.tools.scanexam.core.templates.util;
...
public class TemplatesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TemplatesPackage.CORRECTION_TEMPLATE: {
				CorrectionTemplate correctionTemplate = (CorrectionTemplate)theEObject;
				T result = caseCorrectionTemplate(correctionTemplate);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Correction Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Correction Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCorrectionTemplate(CorrectionTemplate object) {
		return null;
	}
